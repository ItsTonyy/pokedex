...
export const backgroundColorTernary = (mainType: string) => {
  const style =
      mainType === 'grass'
...
export const type1ColorTernary = (mainType: string) => {
  const style = mainType === 'grass'
  ? 'bg-type-grass'
  : mainType === 'dark'
    ? 'bg-type-dark'
...
export const type2ColorTernary = (secondType: string) => {
  const style = secondType === 'grass'
  ? 'bg-type-grass'
  : secondType === 'dark'
    ? 'bg-type-dark'
    : secondType === 'dragon'
